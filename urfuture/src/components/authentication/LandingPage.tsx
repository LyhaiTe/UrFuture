    ...
    <div className="min-h-screen bg-dark-bg text-slate-100 flex flex-col selection:bg-brand-cyan/30 selection:text-white">
            ...
            <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-2">
              {NAV_LINKS.map((link) => (
                <button
                  key={link.id}
                  onClick={() => scrollToSection(link.id)}
                  className="text-left px-4 py-3 rounded-lg text-sm font-semibold text-slate-300 hover:text-white hover:bg-dark-navSurface transition-colors"
                >
                  {link.label}
                </button>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 max-w-2xl">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-dark-chip border border-brand-cyan/30 text-brand-cyan text-xs font-bold mb-8">
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="relative bg-dark-panel/80 backdrop-blur-xl border border-dark-borderPanel rounded-2xl p-8 sm:p-10 shadow-2xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="p-6 rounded-xl bg-dark-panelAlt border border-dark-divider hover:border-brand-cyan/50 transition-all group">
              ...
              <div className="p-6 rounded-xl bg-dark-panelAlt border border-dark-divider hover:border-brand-emerald/50 transition-all group">
              ...
              <div className="p-6 rounded-xl bg-dark-panelAlt border border-dark-divider hover:border-brand-violet/50 transition-all group">
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-dark-borderSubtle">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-dark-panel border border-dark-borderPanel hover:border-brand-cyan/50 transition-all group">
              ...
              <h3 className="text-base font-bold text-white mb-2">Transcript-Grounded Profile</h3>
            ...
            <div className="p-6 rounded-2xl bg-dark-panel border border-dark-borderPanel hover:border-brand-emerald/50 transition-all group">
              ...
              <h3 className="text-base font-bold text-white mb-2">Adaptive Knowledge Diagnostics</h3>
            ...
            <div className="p-6 rounded-2xl bg-dark-panel border border-dark-borderPanel hover:border-brand-amber/50 transition-all group">
              ...
              <h3 className="text-base font-bold text-white mb-2">Cited Career & Job-Fit Matching</h3>
            ...
            <div className="p-6 rounded-2xl bg-dark-panel border border-dark-borderPanel hover:border-brand-violet/50 transition-all group">
              ...
              <h3 className="text-base font-bold text-white mb-2">Personalized Study Roadmaps</h3>
            ...
            <div className="p-6 rounded-2xl bg-dark-panel border border-dark-borderPanel hover:border-brand-blueAmbient/50 transition-all group">
              ...
              <h3 className="text-base font-bold text-white mb-2">Counselor Safety Gate</h3>
            ...
            <div className="p-6 rounded-2xl bg-dark-panel border border-dark-borderPanel hover:border-brand-mint/50 transition-all group">
              ...
              <h3 className="text-base font-bold text-white mb-2">AI Copilot Chat</h3>
      ...
      <section id="how-it-works" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-dark-borderSubtle">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-dark-panel border border-dark-borderPanel rounded-2xl p-6 hover:border-brand-cyan/50 transition-all group">
            ...
            <div className="bg-dark-panel border border-dark-borderPanel rounded-2xl p-6 hover:border-brand-emerald/50 transition-all group">
            ...
            <div className="bg-dark-panel border border-dark-borderPanel rounded-2xl p-6 hover:border-brand-amber/50 transition-all group">
            ...
            <div className="bg-dark-panel border border-dark-borderPanel rounded-2xl p-6 hover:border-brand-violet/50 transition-all group">
      ...
      <section id="grounding" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-dark-borderSubtle">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-dark-panel border border-dark-borderPanel rounded-2xl p-8">
      ...
      <section id="testimonials" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-dark-borderSubtle">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-dark-panel border border-dark-borderPanel rounded-2xl p-8 flex flex-col justify-between">
